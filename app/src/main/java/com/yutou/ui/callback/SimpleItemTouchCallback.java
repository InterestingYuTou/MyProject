...
public class SimpleItemTouchCallback extends ItemTouchHelper.Callback {
    ...
    private List<ProductBean.ListBean.ProductListBean> mData;

    public SimpleItemTouchCallback(ProductAdapter adapter, List<ProductBean.ListBean.ProductListBean> data) {
        mAdapter = adapter;
        mData = data;
    }
